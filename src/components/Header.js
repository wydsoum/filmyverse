...
const Header = () => {
  ...
  return (
      <div className='sticky z-10 header top-0 text-3xl flex justify-between items-center text-pink-600 font-bold p-3 border-b-2 border-gray-500'>
        ...
        :
        <Link to={'/login'}><h1 className='text-lg bg-pink-600 cursor-pointer flex items-center'>
